...
/* External interrupt is generated by devices outside the
...
/* Handler for interrupts, faults, and exceptions.  This
...
intr_handler (struct intr_frame *frame) 
{
  ...
  if (handler != NULL)
    ...
    {
      /* There are no handlers but this interrupt can trigger
